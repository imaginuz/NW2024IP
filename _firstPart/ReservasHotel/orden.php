...
if (isset($_POST["btnEnviar"])) {
    ...
    if ($producto !== null && !empty($txtNombre) && $txtCantidad > 0) {
        ...
        $txtMessage = "Habitacion Reservada Satisfactoriamente";
    } else {
        $txtMessage = "Habitacion o valores no están dentro de lo permitido";
    }
}
...
<body>
    ...
    <form action="orden.php" method="post">
        <label for="cmbProductos">Seleccion el tipo de habitacion</label>
